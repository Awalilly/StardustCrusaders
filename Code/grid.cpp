...
//#include "Game.cpp"
#include "ship.h"
#include "SuperStarDestroyer.cpp"
#include "StarDestroyer.cpp"
#include "GozantiCruiser.cpp"
#include "TIEFighter.cpp"
...
bool grid::isShotBy(grid board){
    ...
    //Controlli sui tre scenari
        ...
        // Vorrei che tutte le scritte si cancellassero. Va bene usare system("cls")?
                    ...
                    */
                    ...
                    if(vec_side [0] == 1 && vec_side [2] == 1 && vec_hit [3] == 1){
                        ...
                        if(*orientation == 1){  //orientazione orizzontale
                            ...
                            if(theGrid[i][j + k]  != miss != miss && theGrid[i][j + k] != sunk && theGrid[i][j + k] != hit){ //se trova qualcosa da colpire colpisce
                                y = j + k;
                                x = 0;
                                goto end;
                            }
